...
AX_S32 SampleVirIntraInterval(AX_S32 VencChn, AX_VOID *handle)
{
    ...
    if (stChnAttr.stGopAttr.stOneLTR.stPicSpecialConfig.s32Interval == 10)
        stChnAttr.stGopAttr.stOneLTR.stPicSpecialConfig.s32Interval = 20;
    else
        stChnAttr.stGopAttr.stOneLTR.stPicSpecialConfig.s32Interval = 10;

    SAMPLE_LOG("chn-%d: interval = %d.\n", VencChn, stChnAttr.stGopAttr.stOneLTR.stPicSpecialConfig.s32Interval);
