...
static SAMPLE_OPTION_T options[] = {
    ...
    {"qpDeltaRgn", '0', 1}, /* QP adjustment for intra frames */
...
AX_S32 SampleCmdLineParse(AX_S32 argc, AX_CHAR **argv, SAMPLE_VENC_CMD_PARA_T *pstPara)
{
    ...
    while ((ret = SampleGetOption(argc, argv, options, &prm)) != -1) {
        ...
        case '0':
            ...
            if (strcmp(pPrm->longOpt, "qpDeltaRgn") == 0) {
                cml->qpDeltaRgn = atoi(optarg);
                break;
            }
            ...
            if (strcmp(pPrm->longOpt, "bRepeat") == 0) {
                cml->bRepeat = atoi(optarg);
                break;
            }
            ...
            if (strcmp(pPrm->longOpt, "sceneChgThr") == 0) {
                cml->sceneChgThr = atoi(optarg);
                break;
            }
