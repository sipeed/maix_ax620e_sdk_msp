...
```
  ...
  --bRepeat                             Repeat execution feature test.
...
```
  ...
  --vq                                  0..10 video quality level for vbr, def 0, min/max qp is invalid when vq != 0
  ...
  --qpDeltaRgn                          1-10, qp delta range [10]
  --maxIprop                            1..100, the max I P size ratio. [40]
  --minIprop                            1..maxIprop, the min I P size ratio. [10]
  ...
  --sceneChgThr                      vbr/avbr scenechg 1-10,def 1.(eis not support)
...
```
  --ut                                  encoder feature test. [0]
                                        ...
                                        28:UT_CASE_CHG_QPMAP             29:UT_CASE_CREATE_CHN_EX
```
