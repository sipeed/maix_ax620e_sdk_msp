...
static AX_S32 SAMPLE_FillFrameWithMaskByCpu(const AX_VIDEO_FRAME_T *pstVFrame, const SAMPLE_IVPS_MASK_T *ptMask, char *strFilePath, char *pCaseId)
{
...
{
    SAMPLE_FillFrameWithMaskByCpu(ptSrc, ptMask, strFilePath, pCaseId);
    return 0;
}