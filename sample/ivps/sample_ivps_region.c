...
/* Rect config */
static AX_VOID IVPS_RegionCfg7(AX_IVPS_RGN_DISP_GROUP_T *ptRegion)
{
    ptRegion->nNum = 8;
    ptRegion->tChnAttr.nZindex = 2;
    ptRegion->tChnAttr.nAlpha = 200; /* (0, 255], 0: transparent, 255: opaque */
    ptRegion->tChnAttr.eFormat = AX_FORMAT_ARGB8888;
    ptRegion->arrDisp[0].bShow = AX_TRUE;
    ptRegion->arrDisp[0].eType = AX_IVPS_RGN_TYPE_RECT;
    ptRegion->arrDisp[0].uDisp.tPolygon.tRect.nX = 298;
    ptRegion->arrDisp[0].uDisp.tPolygon.tRect.nY = 348;
    ptRegion->arrDisp[0].uDisp.tPolygon.tRect.nW = 1094;
    ptRegion->arrDisp[0].uDisp.tPolygon.tRect.nH = 482;
    ptRegion->arrDisp[0].uDisp.tPolygon.bSolid = AX_TRUE;
    ptRegion->arrDisp[0].uDisp.tPolygon.nLineWidth = 0;
    ptRegion->arrDisp[0].uDisp.tPolygon.nColor = RED;
    ptRegion->arrDisp[0].uDisp.tPolygon.nAlpha = 200;

    ptRegion->arrDisp[1].bShow = AX_TRUE;
    ptRegion->arrDisp[1].eType = AX_IVPS_RGN_TYPE_RECT;
    ptRegion->arrDisp[1].uDisp.tPolygon.tRect.nX = 1824;
    ptRegion->arrDisp[1].uDisp.tPolygon.tRect.nY = 280;
    ptRegion->arrDisp[1].uDisp.tPolygon.tRect.nW = 374;
    ptRegion->arrDisp[1].uDisp.tPolygon.tRect.nH = 280;
    ptRegion->arrDisp[1].uDisp.tPolygon.bSolid = AX_TRUE;
    ptRegion->arrDisp[1].uDisp.tPolygon.nLineWidth = 0;
    ptRegion->arrDisp[1].uDisp.tPolygon.nColor = RED;
    ptRegion->arrDisp[1].uDisp.tPolygon.nAlpha = 200;

    ptRegion->arrDisp[2].bShow = AX_TRUE;
    ptRegion->arrDisp[2].eType = AX_IVPS_RGN_TYPE_RECT;
    ptRegion->arrDisp[2].uDisp.tPolygon.tRect.nX = 884;
    ptRegion->arrDisp[2].uDisp.tPolygon.tRect.nY = 1108;
    ptRegion->arrDisp[2].uDisp.tPolygon.tRect.nW = 116;
    ptRegion->arrDisp[2].uDisp.tPolygon.tRect.nH = 366;
    ptRegion->arrDisp[2].uDisp.tPolygon.bSolid = AX_TRUE;
    ptRegion->arrDisp[2].uDisp.tPolygon.nLineWidth = 0;
    ptRegion->arrDisp[2].uDisp.tPolygon.nColor = RED;
    ptRegion->arrDisp[2].uDisp.tPolygon.nAlpha = 200;

    ptRegion->arrDisp[3].bShow = AX_TRUE;
    ptRegion->arrDisp[3].eType = AX_IVPS_RGN_TYPE_RECT;
    ptRegion->arrDisp[3].uDisp.tPolygon.tRect.nX = 1564;
    ptRegion->arrDisp[3].uDisp.tPolygon.tRect.nY = 1022;
    ptRegion->arrDisp[3].uDisp.tPolygon.tRect.nW = 202;
    ptRegion->arrDisp[3].uDisp.tPolygon.tRect.nH = 280;
    ptRegion->arrDisp[3].uDisp.tPolygon.bSolid = AX_TRUE;
    ptRegion->arrDisp[3].uDisp.tPolygon.nLineWidth = 0;
    ptRegion->arrDisp[3].uDisp.tPolygon.nColor = RED;
    ptRegion->arrDisp[3].uDisp.tPolygon.nAlpha = 200;

    ptRegion->arrDisp[4].bShow = AX_TRUE;
    ptRegion->arrDisp[4].eType = AX_IVPS_RGN_TYPE_RECT;
    ptRegion->arrDisp[4].uDisp.tPolygon.tRect.nX = 2074;
    ptRegion->arrDisp[4].uDisp.tPolygon.tRect.nY = 588;
    ptRegion->arrDisp[4].uDisp.tPolygon.tRect.nW = 124;
    ptRegion->arrDisp[4].uDisp.tPolygon.tRect.nH = 202;
    ptRegion->arrDisp[4].uDisp.tPolygon.bSolid = AX_TRUE;
    ptRegion->arrDisp[4].uDisp.tPolygon.nLineWidth = 0;
    ptRegion->arrDisp[4].uDisp.tPolygon.nColor = RED;
    ptRegion->arrDisp[4].uDisp.tPolygon.nAlpha = 200;

    ptRegion->arrDisp[5].bShow = AX_TRUE;
    ptRegion->arrDisp[5].eType = AX_IVPS_RGN_TYPE_RECT;
    ptRegion->arrDisp[5].uDisp.tPolygon.tRect.nX = 1478;
    ptRegion->arrDisp[5].uDisp.tPolygon.tRect.nY = 1282;
    ptRegion->arrDisp[5].uDisp.tPolygon.tRect.nW = 1296;
    ptRegion->arrDisp[5].uDisp.tPolygon.tRect.nH = 578;
    ptRegion->arrDisp[5].uDisp.tPolygon.bSolid = AX_TRUE;
    ptRegion->arrDisp[5].uDisp.tPolygon.nLineWidth = 0;
    ptRegion->arrDisp[5].uDisp.tPolygon.nColor = RED;
    ptRegion->arrDisp[5].uDisp.tPolygon.nAlpha = 200;

    ptRegion->arrDisp[6].bShow = AX_TRUE;
    ptRegion->arrDisp[6].eType = AX_IVPS_RGN_TYPE_RECT;
    ptRegion->arrDisp[6].uDisp.tPolygon.tRect.nX = 2380;
    ptRegion->arrDisp[6].uDisp.tPolygon.tRect.nY = 712;
    ptRegion->arrDisp[6].uDisp.tPolygon.tRect.nW = 720;
    ptRegion->arrDisp[6].uDisp.tPolygon.tRect.nH = 366;
    ptRegion->arrDisp[6].uDisp.tPolygon.bSolid = AX_TRUE;
    ptRegion->arrDisp[6].uDisp.tPolygon.nLineWidth = 0;
    ptRegion->arrDisp[6].uDisp.tPolygon.nColor = RED;
    ptRegion->arrDisp[6].uDisp.tPolygon.nAlpha = 200;

    ptRegion->arrDisp[7].bShow = AX_TRUE;
    ptRegion->arrDisp[7].eType = AX_IVPS_RGN_TYPE_RECT;
    ptRegion->arrDisp[7].uDisp.tPolygon.tRect.nX = 432;
    ptRegion->arrDisp[7].uDisp.tPolygon.tRect.nY = 192;
    ptRegion->arrDisp[7].uDisp.tPolygon.tRect.nW = 2744;
    ptRegion->arrDisp[7].uDisp.tPolygon.tRect.nH = 1388;
    ptRegion->arrDisp[7].uDisp.tPolygon.bSolid = AX_FALSE;
    ptRegion->arrDisp[7].uDisp.tPolygon.nLineWidth = 6;
    ptRegion->arrDisp[7].uDisp.tPolygon.nColor = RED;
    ptRegion->arrDisp[7].uDisp.tPolygon.nAlpha = 200;
}
...
static AX_S32 IVPS_RegionUpdate(AX_U32 nRgnNum)
{
    ...
    for (int index = 0; index < nRgnNum; index++)
    {
...
static AX_VOID *IVPS_RegionUpdateThread(AX_VOID *pArg)
{
    ...
    while (!ThreadLoopStateGet() && gSampleIvpsMain.bRegionThread)
    {
...
AX_S32 IVPS_RegionUpdateThreadStart(AX_S32 nRegionNum, SAMPLE_IVPS_GRP_T *pGrp, AX_BOOL bStopTest)
{
    ...
    else
    {
        ...
        gSampleIvpsMain.bRegionThread = AX_TRUE;
        if (0 != pthread_create(&gSampleIvpsMain.region_tid, NULL, IVPS_RegionUpdateThread, (AX_VOID *)(AX_LONG)nRegionNum))
        {
            return -1;
        }
    }
...
{
    if (!bStopTest) {
        gSampleIvpsMain.bRegionThread = AX_FALSE;
