...
{
    if (!strcmp(str, "AX_FORMAT_YUV400"))
    {
        *eDstPicFormat = AX_FORMAT_YUV400;
        return 0;
    }
    ...
    if (!strcmp(str, "AX_FORMAT_YUV422_INTERLEAVED_YVYU"))
    {
        *eDstPicFormat = AX_FORMAT_YUV422_INTERLEAVED_YVYU;
        return 0;
    }
    if (!strcmp(str, "AX_FORMAT_YUV422_INTERLEAVED_UYVY"))
    {
        *eDstPicFormat = AX_FORMAT_YUV422_INTERLEAVED_UYVY;
        return 0;
    }
    if (!strcmp(str, "AX_FORMAT_YUV422_INTERLEAVED_VYUY"))
    {
        *eDstPicFormat = AX_FORMAT_YUV422_INTERLEAVED_VYUY;
        return 0;
    }
...
enum LONG_OPTION
{
    ...
    LONG_OPTION_CONFIG_RESIZE,
    LONG_OPTION_CONFIG_LDC,
    ...
    LONG_OPTION_CONFIG_FBC,
    LONG_OPTION_CONFIG_ALPHA,
    LONG_OPTION_CONFIG_X0,
    LONG_OPTION_CONFIG_Y0,
    LONG_OPTION_CONFIG_MESH_FILE,
    LONG_OPTION_CONFIG_MESH_WIDTH,
    LONG_OPTION_CONFIG_MESH_HEIGHT,
...
static struct option long_options[] = {
    ...
    {"resize", required_argument, NULL, LONG_OPTION_CONFIG_RESIZE},
    {"LDC", required_argument, NULL, LONG_OPTION_CONFIG_LDC},
    ...
    {"FBC", required_argument, NULL, LONG_OPTION_CONFIG_FBC},
    {"alpha", required_argument, NULL, LONG_OPTION_CONFIG_ALPHA},
    {"X0", required_argument, NULL, LONG_OPTION_CONFIG_X0},
    {"Y0", required_argument, NULL, LONG_OPTION_CONFIG_Y0},
    {"meshfile", required_argument, NULL, LONG_OPTION_CONFIG_MESH_FILE},
    {"meshwidth", required_argument, NULL, LONG_OPTION_CONFIG_MESH_WIDTH},
    {"meshheight", required_argument, NULL, LONG_OPTION_CONFIG_MESH_HEIGHT},
...
int IVPS_ArgsParser(int argc, char *argv[], IVPS_ARG_T *ptArg)
{
    ...
    ptArg->nX0 = 128;
    ptArg->nY0 = 64;
    ptArg->bPipeline = AX_FALSE;
    ptArg->bSyncApi = AX_FALSE;
    ptArg->tChnInfo[0].nW = 1024;
    ptArg->tChnInfo[0].nH = 1024;
    ptArg->tResizeAttr.nAspectMode = AX_IVPS_ASPECT_RATIO_STRETCH;
    ptArg->tResizeAttr.nBGColor = 0x0000FF;
    ptArg->tResizeAttr.nDstFormat = SAMPLE_IVPS_FORMAT_INVAILD;
    ...
    while ((c = getopt_long(argc, argv, "v:a:g:s:c:p:t:n:r:l:", long_options, &option_index)) != -1)
    {
        ...
        case LONG_OPTION_CONFIG_CROP:
            ...
            break;
        case LONG_OPTION_CONFIG_RESIZE:
            CHECK_RESULT(ResizeInfoParse(optarg, &ptArg->tResizeAttr));
            break;
        case LONG_OPTION_CONFIG_LDC:
            CHECK_RESULT(LdcInfoParse(optarg, &ptArg->tLdcAttr, &ptArg->nFilterId));
            ptArg->bLdcAttr = AX_TRUE;
            break;
        ...
        case LONG_OPTION_CONFIG_FORMAT:
            ...
            ptArg->tResizeAttr.nDstFormat = ptArg->nFormat;
            break;
        case LONG_OPTION_CONFIG_FBC:
            ptArg->nFbcLevel = atoi(optarg);
            break;
        case LONG_OPTION_CONFIG_ALPHA:
            ptArg->nAlpha = atoi(optarg);
            break;
        case LONG_OPTION_CONFIG_X0:
            ptArg->nX0 = atoi(optarg);
            break;
        case LONG_OPTION_CONFIG_Y0:
            ptArg->nY0 = atoi(optarg);
            break;
        case LONG_OPTION_CONFIG_MESH_FILE:
            ptArg->pMeshFile = optarg;
            break;
        case LONG_OPTION_CONFIG_MESH_WIDTH:
            ptArg->nMeshWidth = atoi(optarg);
            break;
        case LONG_OPTION_CONFIG_MESH_HEIGHT:
            ptArg->nMeshHeight = atoi(optarg);
            break;
