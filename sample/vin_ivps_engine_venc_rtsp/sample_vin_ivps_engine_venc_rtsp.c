...
COMMON_SYS_POOL_CFG_T gtSysCommPoolSingleOs04d10Sdr[] = {
    {2560, 1440, 2560, AX_FORMAT_YUV420_SEMIPLANAR, 3, AX_COMPRESS_MODE_LOSSY, 4},    /* vin nv21/nv21 use */
    {2560, 1440, 2560, AX_FORMAT_YUV420_SEMIPLANAR, 4},    /* vin nv21/nv21 use */
    {1920, 1080, 1920, AX_FORMAT_YUV420_SEMIPLANAR, 3},    /* vin nv21/nv21 use */
    {720, 576, 720, AX_FORMAT_YUV420_SEMIPLANAR, 3},    /* vin nv21/nv21 use */
};

COMMON_SYS_POOL_CFG_T gtPrivatePoolSingleOs04d10Sdr[] = {
    {2560, 1440, 2560, AX_FORMAT_BAYER_RAW_10BPP_PACKED, 8, AX_COMPRESS_MODE_LOSSY, 4},      /* vin raw10 use */
};

// SC850SL
COMMON_SYS_POOL_CFG_T gtSysCommPoolSingleSc850slSdr[] = {
    {3840, 2160, 3840, AX_FORMAT_YUV420_SEMIPLANAR, 5, AX_COMPRESS_MODE_LOSSY, 4},    /* vin nv21/nv21 use */
    {3840, 2160, 2688, AX_FORMAT_YUV420_SEMIPLANAR, 5},    /* vin nv21/nv21 use */
    {1920, 1080, 1920, AX_FORMAT_YUV420_SEMIPLANAR, 3},    /* vin nv21/nv21 use */
    {720, 576, 720, AX_FORMAT_YUV420_SEMIPLANAR, 3},    /* vin nv21/nv21 use */
};
...
static int SAMPLE_IVPS_Init(AX_S32 nGrpId, AX_S32 nChnNum, AX_IVPS_ROTATION_E eRotAngle)
{
    ...
    stPipelineAttr.tFilter[ALGO_CHN + 1][0].tAspectRatio.eMode = AX_IVPS_ASPECT_RATIO_STRETCH;
...
// ### SIPEED EDIT ###
    printf("\t\t3: Single SC850SL\n");
    printf("\t\t4: Single OS04D10\n");
// ### SIPEED EDIT END ###
    ...
    printf("\nSC450AI:\n");
    printf("\nExample:\n\t/opt/bin/sample_vin_ivps_engine_venc_rtsp -c 2 -m 1 -e 1 -r 1\n");

    // ### SIPEED EDIT ###
    printf("\nSC850SL:\n");
    printf("\nExample:\n\t/opt/bin/sample_vin_ivps_engine_venc_rtsp -c 3 -m 1 -e 1 -r 1\n");
    printf("\nOS04D10:\n");
    printf("\nExample:\n\t/opt/bin/sample_vin_ivps_engine_venc_rtsp -c 4 -m 1 -e 1 -r 1\n");
    // ### SIPEED EDIT END ###
}
