...
static void os04a10_init(ISP_PIPE_ID nPipeId)
{
    ...
    /* 4. refresh ae param */
    os04a10_cfg_aec_param_lf(nPipeId);

    /* 5. refresh ae regs table */
    os04a10_sns_refresh_all_regs_from_tbl_lf(nPipeId);
...
AX_SYS_API_PUBLIC AX_SENSOR_REGISTER_FUNC_T gSnsos04a10ObjLf = {
    ...
    .pfn_sensor_set_fps                     = os04a10_set_fps_lf,
    .pfn_sensor_get_fps                     = os04a10_get_fps_lf,
    ...
    /* ae ctrl */
    .pfn_sensor_get_hw_exposure_params      = os04a10_get_hw_exposure_params_lf,
    .pfn_sensor_get_gain_table              = os04a10_get_sensor_gain_table_lf,
    .pfn_sensor_set_again                   = os04a10_set_again_lf,
    .pfn_sensor_set_dgain                   = os04a10_set_dgain_lf,
    .pfn_sensor_hcglcg_ctrl                 = os04a10_hcglcg_ctrl_lf,

    .pfn_sensor_set_integration_time        = os04a10_set_integration_time_lf,
    .pfn_sensor_get_integration_time_range  = os04a10_get_integration_time_range_lf,
    .pfn_sensor_set_slow_fps                = os04a10_set_slow_fps_lf,
    .pfn_sensor_get_slow_shutter_param      = os04a10_get_slow_shutter_param_lf,
    .pfn_sensor_get_sns_reg_info            = os04a10_ae_get_sensor_reg_info_lf,
