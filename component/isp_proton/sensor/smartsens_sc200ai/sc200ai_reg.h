...
#define SC200AI_SENSOR_ID_REG_H  (0x3107)
#define SC200AI_SENSOR_ID_REG_L  (0x3108)
...
AX_U32 sc200ai_sns_update_regs_table(ISP_PIPE_ID nPipeId, AX_U32 nRegsAddr, AX_U8 nRegsValue);
