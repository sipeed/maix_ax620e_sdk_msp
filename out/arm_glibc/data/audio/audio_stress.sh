...
/opt/bin/sample_audio ai_aenc -D 0 -d 0 -G 30000 -r 48000 -p 480 --aec-mode 2 --routing-mode 0 --ns 1 --ag-level 2 --agc 1 --target-level -3 --resample 1 --resrate 48000 --layout 1 -e opus --aenc-chns 1 &
/opt/bin/sample_audio adec_ao -D 0 -d 1 -L 120 -r 48000  --ns 1 --ag-level 2 --agc 1 --target-level -3  -e g711a -i /opt/data/audio/audio_test.g711a
